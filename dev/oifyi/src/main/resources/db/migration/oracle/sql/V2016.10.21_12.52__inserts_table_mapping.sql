UPDATE mapping_url_fichier
SET chemin_fichier = 'accueil/accueil.jsp'
WHERE nom_page = 'accueil' AND nom_mode = 'view' AND chemin_fichier = 'accueil.jsp';

UPDATE mapping_url_fichier
SET nom_page = 'accueil', nom_mode = 'connexion', chemin_fichier = 'accueil/connexion.jsp'
WHERE nom_page = 'connexion' AND nom_mode = 'view' AND chemin_fichier = 'connexion.jsp';
