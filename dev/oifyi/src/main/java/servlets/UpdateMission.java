...
public class UpdateMission extends HttpServlet {
    ...
    private String url_page_update_mission = MappingUrlFichierDAO.getMuf("missions", "update").formerUrl();
    private String url_page_listing_missions = MappingUrlFichierDAO.getMuf("missions", "list").formerUrl();
